...
void displayUpdate(deviceStateInfo_t deviceState, uint32_t currentTime); // Update the display, given the device's state and the length of the current workout
