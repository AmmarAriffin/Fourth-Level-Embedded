...
void displayUpdate(deviceStateInfo_t deviceState, uint16_t currentTime); // Update the display, given the device's state and the length of the current workout
